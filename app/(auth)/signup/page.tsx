            ...
            <div className="bg-card border border-border rounded-xl p-8 shadow-lg">
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-xs">
                        <span className="px-2 bg-card text-muted-foreground uppercase">Or continue with</span>
                    </div>
                </div>
                ...
                <button
                    ...
                    className="w-full h-10 flex items-center justify-center gap-3 border border-border rounded-lg hover:bg-muted/50 transition-colors"
                >
